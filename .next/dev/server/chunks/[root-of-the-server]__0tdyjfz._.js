        ...
        run: async ({ file_path, view_range })=>{
            ...
            try {
                ...
                if (st.size > READ_MAX_BYTES) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$lib$2f$tools$2f$ToolError$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ToolError"](`read: ${file_path} is ${st.size} bytes, exceeds ${READ_MAX_BYTES}-byte limit. ` + 'Use bash (head/tail/sed) to read a slice.');
                }
        ...
        run: async ({ file_path, old_string, new_string, replace_all })=>{
            ...
            try {
                ...
                if (st.size > EDIT_MAX_BYTES) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$lib$2f$tools$2f$ToolError$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ToolError"](`edit: ${file_path} is ${st.size} bytes, exceeds ${EDIT_MAX_BYTES}-byte limit. ` + 'Use bash (sed/awk) to edit a large file.');
                }
                data = await __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["readFile"](abs, 'utf8');
            } catch (e) {
                if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$lib$2f$tools$2f$ToolError$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ToolError"]) throw e;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0tdyjfz._.js.map